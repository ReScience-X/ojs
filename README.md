...
ReSciX resci-master [![Build Status](https://travis-ci.org/ReScience-X/ojs.svg?branch=resci-master)](http://rescience.org) | master [![Build Status](https://travis-ci.org/ReScience-X/ojs.svg?branch=master)](http://rescience.org) | OJS [![Build Status](https://travis-ci.org/pkp/ojs.svg?branch=master)](https://travis-ci.org/pkp/ojs)
